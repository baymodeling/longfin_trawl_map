...
Pred_data = [r"C:\git\longfin_trawl_map\new_predicted_06132019\results\results\predicted_cohort_abundance_quantiles_test_A.csv",
             r"C:\git\longfin_trawl_map\new_predicted_06132019\results\results\predicted_cohort_abundance_quantiles_test_B.csv"]
sizes = [6,9]
surveys = [1,2,3,4,5,6]
cohorts = [1,2,3,4,5,6]
